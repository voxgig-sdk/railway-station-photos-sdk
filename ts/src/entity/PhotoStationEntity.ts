...
class PhotoStationEntity extends RailwayStationPhotosEntityBase<PhotoStation> {
  ...
  constructor(client: RailwayStationPhotosSDK, entopts: any) {
    ...
    this.name = 'photo_station'
    this.name_ = 'photo_station'
    this.Name = 'PhotoStation'
  }


  make(this: PhotoStationEntity) {
    return new PhotoStationEntity(this._client, this.entopts())
  }
