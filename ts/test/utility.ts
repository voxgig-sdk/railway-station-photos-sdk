...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.RAILWAYSTATIONPHOTOS_TEST_LIVE ||
    'TRUE' === process.env.RAILWAYSTATIONPHOTOS_TEST_OVERRIDE
  ) {
  ...
  m.RAILWAYSTATIONPHOTOS_TEST_EXPLAIN = process.env.RAILWAYSTATIONPHOTOS_TEST_EXPLAIN || m.RAILWAYSTATIONPHOTOS_TEST_EXPLAIN
