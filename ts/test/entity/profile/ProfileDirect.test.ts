...
describe('ProfileDirect', async () => {
  ...
  test('direct-load-profile', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-profile', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['RAILWAYSTATIONPHOTOS_TEST_PROFILE_ENTID']
