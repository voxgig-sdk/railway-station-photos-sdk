...
describe('PhotographerDirect', async () => {
  ...
  test('direct-load-photographer', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-photographer', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['RAILWAYSTATIONPHOTOS_TEST_PHOTOGRAPHER_ENTID']
