...
describe('InboxCountDirect', async () => {
  ...
  test('direct-load-inbox_count', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-inbox_count', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['RAILWAYSTATIONPHOTOS_TEST_INBOX_COUNT_ENTID']
