...
describe('InboxEntryDirect', async () => {
  ...
  test('direct-list-inbox_entry', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-inbox_entry', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['RAILWAYSTATIONPHOTOS_TEST_INBOX_ENTRY_ENTID']
