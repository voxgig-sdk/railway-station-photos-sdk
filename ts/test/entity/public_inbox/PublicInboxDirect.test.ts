...
describe('PublicInboxDirect', async () => {
  ...
  test('direct-list-public_inbox', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-public_inbox', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['RAILWAYSTATIONPHOTOS_TEST_PUBLIC_INBOX_ENTID']
