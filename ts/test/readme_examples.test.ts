...
//     (\`new RailwayStationPhotosSDK(...)\` / \`RailwayStationPhotosSDK.test(...)\` become
//     \`RailwayStationPhotosSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'RailwayStationPhotosSDK'
...
const TEST_SEED = {"entity":{"admin_inbox":{"test01":{"id":"test01"}},"country":{"test01":{"id":"test01"}},"inbox":{"test01":{"id":"test01"}},"inbox_count":{"test01":{"id":"test01"}},"inbox_entry":{"test01":{"id":"test01"}},"inbox_state_query":{"test01":{"id":"test01"}},"o_auth_token":{"test01":{"id":"test01"}},"oauth":{"test01":{"id":"test01"}},"photo":{"test01":{"id":"test01"}},"photo_download":{"test01":{"id":"test01"}},"photo_station":{"test01":{"id":"test01"}},"photo_upload":{"test01":{"id":"test01"}},"photographer":{"test01":{"id":"test01"}},"profile":{"test01":{"id":"test01"}},"public_inbox":{"test01":{"id":"test01"}},"stat":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new RailwayStationPhotosSDK(...)\` and any
// \`RailwayStationPhotosSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+RailwayStationPhotosSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/RailwayStationPhotosSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
