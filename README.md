...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/railway-station-photos` | `npm install @voxgig-sdk/railway-station-photos` |
| Python | `voxgig-sdk-railway-station-photos` | `pip install voxgig-sdk-railway-station-photos` |
| PHP | `voxgig-sdk/railway-station-photos` | `composer require voxgig-sdk/railway-station-photos` |
| Golang | `github.com/voxgig-sdk/railway-station-photos-sdk/go` | `go get github.com/voxgig-sdk/railway-station-photos-sdk/go` |
| Ruby | `voxgig-sdk-railway-station-photos` | `gem install voxgig-sdk-railway-station-photos` |
| Lua | `voxgig-sdk-railway-station-photos` | `luarocks install voxgig-sdk-railway-station-photos` |
