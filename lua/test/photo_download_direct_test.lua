...
describe("PhotoDownloadDirect", function()
  it("should direct-load-photo_download", function()
    local setup = photo_download_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-photo_download", setup.live and "live" or "unit")
...
function photo_download_direct_setup(mockres)
