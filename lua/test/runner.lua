...
function runner.env_override(m)
  local live = runner.getenv("RAILWAYSTATIONPHOTOS_TEST_LIVE")
  local override = runner.getenv("RAILWAYSTATIONPHOTOS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RAILWAYSTATIONPHOTOS_TEST_EXPLAIN")
