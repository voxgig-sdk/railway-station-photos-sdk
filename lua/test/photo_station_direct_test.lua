...
describe("PhotoStationDirect", function()
  it("should direct-list-photo_station", function()
    local setup = photo_station_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-photo_station", setup.live and "live" or "unit")
  ...
  it("should direct-load-photo_station", function()
    local setup = photo_station_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-photo_station", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function photo_station_direct_setup(mockres)
