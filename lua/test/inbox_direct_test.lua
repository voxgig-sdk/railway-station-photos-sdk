...
describe("InboxDirect", function()
  it("should direct-list-inbox", function()
    local setup = inbox_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-inbox", setup.live and "live" or "unit")
