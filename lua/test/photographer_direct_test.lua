...
describe("PhotographerDirect", function()
  it("should direct-load-photographer", function()
    local setup = photographer_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-photographer", setup.live and "live" or "unit")
...
function photographer_direct_setup(mockres)
