...
describe("InboxEntryDirect", function()
  it("should direct-list-inbox_entry", function()
    local setup = inbox_entry_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-inbox_entry", setup.live and "live" or "unit")
...
function inbox_entry_direct_setup(mockres)
