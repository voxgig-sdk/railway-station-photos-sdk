...
describe("InboxCountDirect", function()
  it("should direct-load-inbox_count", function()
    local setup = inbox_count_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-inbox_count", setup.live and "live" or "unit")
...
function inbox_count_direct_setup(mockres)
