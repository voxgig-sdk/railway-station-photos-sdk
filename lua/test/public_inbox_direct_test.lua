...
describe("PublicInboxDirect", function()
  it("should direct-list-public_inbox", function()
    local setup = public_inbox_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-public_inbox", setup.live and "live" or "unit")
...
function public_inbox_direct_setup(mockres)
