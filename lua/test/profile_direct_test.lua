...
describe("ProfileDirect", function()
  it("should direct-load-profile", function()
    local setup = profile_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-profile", setup.live and "live" or "unit")
