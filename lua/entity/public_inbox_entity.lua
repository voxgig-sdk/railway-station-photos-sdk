...
local PublicInboxEntity = {}
PublicInboxEntity.__index = PublicInboxEntity


function PublicInboxEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PublicInboxEntity)
  self._name = "public_inbox"
  self._client = client
...
function PublicInboxEntity:get_name()
  return self._name
end


function PublicInboxEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PublicInboxEntity.new(self._client, opts)
end


function PublicInboxEntity:data_set(args)
  if args ~= nil then
...
function PublicInboxEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PublicInboxEntity:match_set(args)
  if args ~= nil then
...
function PublicInboxEntity:match_get()
...
function PublicInboxEntity:stream(action, args, callopts)
...
---@param reqmatch PublicInboxListMatch
---@param ctrl? table
---@return PublicInbox[]
---@return string? err
function PublicInboxEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PublicInboxEntity:_run_op(ctx, post_done)
  local utility = self._utility
