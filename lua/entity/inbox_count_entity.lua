...
local InboxCountEntity = {}
InboxCountEntity.__index = InboxCountEntity


function InboxCountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InboxCountEntity)
  self._name = "inbox_count"
  self._client = client
...
function InboxCountEntity:get_name()
  return self._name
end


function InboxCountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InboxCountEntity.new(self._client, opts)
end


function InboxCountEntity:data_set(args)
  if args ~= nil then
...
function InboxCountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InboxCountEntity:match_set(args)
  if args ~= nil then
...
function InboxCountEntity:match_get()
...
function InboxCountEntity:stream(action, args, callopts)
...
---@param reqmatch InboxCountLoadMatch
---@param ctrl? table
---@return InboxCount
---@return string? err
function InboxCountEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function InboxCountEntity:_run_op(ctx, post_done)
  local utility = self._utility
