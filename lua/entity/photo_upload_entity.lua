...
local PhotoUploadEntity = {}
PhotoUploadEntity.__index = PhotoUploadEntity


function PhotoUploadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PhotoUploadEntity)
  self._name = "photo_upload"
  self._client = client
...
function PhotoUploadEntity:get_name()
  return self._name
end


function PhotoUploadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PhotoUploadEntity.new(self._client, opts)
end


function PhotoUploadEntity:data_set(args)
  if args ~= nil then
...
function PhotoUploadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PhotoUploadEntity:match_set(args)
  if args ~= nil then
...
function PhotoUploadEntity:match_get()
...
function PhotoUploadEntity:stream(action, args, callopts)
...
---@param reqdata PhotoUploadCreateData
---@param ctrl? table
---@return PhotoUpload
---@return string? err
function PhotoUploadEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PhotoUploadEntity:_run_op(ctx, post_done)
  local utility = self._utility
