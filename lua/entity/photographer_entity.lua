...
local PhotographerEntity = {}
PhotographerEntity.__index = PhotographerEntity


function PhotographerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PhotographerEntity)
  self._name = "photographer"
  self._client = client
...
function PhotographerEntity:get_name()
  return self._name
end


function PhotographerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PhotographerEntity.new(self._client, opts)
end


function PhotographerEntity:data_set(args)
  if args ~= nil then
...
function PhotographerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PhotographerEntity:match_set(args)
  if args ~= nil then
...
function PhotographerEntity:match_get()
...
function PhotographerEntity:stream(action, args, callopts)
...
---@param reqmatch PhotographerLoadMatch
---@param ctrl? table
---@return Photographer
---@return string? err
function PhotographerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PhotographerEntity:_run_op(ctx, post_done)
  local utility = self._utility
