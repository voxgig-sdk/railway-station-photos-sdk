...
const testSeed = `map[string]any{"entity": map[string]any{"admin_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox_count": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox_entry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox_state_query": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "o_auth_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oauth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photo_download": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photo_station": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photo_upload": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photographer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "profile": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stat": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
