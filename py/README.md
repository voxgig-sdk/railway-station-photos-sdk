...
The Python SDK for the RailwayStationPhotos API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.AdminInbox(None).create({"name": "Example"}, None)
...
result, err = client.RailwayStationPhotos(None).load(
    {"id": "test01"}, None
)
