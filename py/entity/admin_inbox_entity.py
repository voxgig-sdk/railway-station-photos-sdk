...
class AdminInboxEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminInboxEntity(self._client, opts)
    ...
    def create(self, reqdata: AdminInboxCreateData, ctrl=None) -> AdminInbox:
        utility = self._utility
