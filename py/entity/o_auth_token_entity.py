...
class OAuthTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OAuthTokenEntity(self._client, opts)
    ...
    def create(self, reqdata: OAuthTokenCreateData, ctrl=None) -> OAuthToken:
        utility = self._utility
