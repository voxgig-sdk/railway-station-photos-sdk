...
class PhotoUploadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhotoUploadEntity(self._client, opts)
    ...
    def match_get(self) -> PhotoUpload:
    ...
    def create(self, reqdata: PhotoUploadCreateData, ctrl=None) -> PhotoUpload:
