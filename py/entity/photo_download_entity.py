...
class PhotoDownloadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhotoDownloadEntity(self._client, opts)
    ...
    def data_get(self) -> PhotoDownload:
    ...
    def match_get(self) -> PhotoDownload:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PhotoDownload:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PhotoDownload().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
