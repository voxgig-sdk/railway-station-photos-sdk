...
class RailwayStationPhotosContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RailwayStationPhotosControl()
        ...
        if isinstance(sp, RailwayStationPhotosSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RailwayStationPhotosResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RailwayStationPhotosResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RailwayStationPhotosOperation({})
    ...
    def make_error(self, code, msg):
        return RailwayStationPhotosError(code, msg, self)
