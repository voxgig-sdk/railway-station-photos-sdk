# RailwayStationPhotos SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RailwayStationPhotosSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RailwayStationPhotosSDK(...) and RailwayStationPhotosSDK.test(...) become
#      RailwayStationPhotosSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "railwaystationphotos_sdk"
_SDK_CLASS = "RailwayStationPhotosSDK"
...
_ENTITIES = {
    ...
    "InboxEntry": "inbox_entry",
    "InboxStateQuery": "inbox_state_query",
    "OAuthToken": "o_auth_token",
    "Oauth": "oauth",
    "Photo": "photo",
    "PhotoDownload": "photo_download",
    "PhotoStation": "photo_station",
