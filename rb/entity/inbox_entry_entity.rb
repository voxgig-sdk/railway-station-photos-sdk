...
class InboxEntryEntity
  ...
  def make
    opts = @_entopts.dup
    InboxEntryEntity.new(@_client, opts)
  end
  ...
  # @return [InboxEntry, Hash] the current InboxEntry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of InboxEntry fields)
  def match_get
  ...
  #
  # @param reqmatch [InboxEntryListMatch, Hash, nil] match filter (any subset of
  #   InboxEntry fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<InboxEntry>, Array] the matching InboxEntry items; raises RailwayStationPhotosError on failure
