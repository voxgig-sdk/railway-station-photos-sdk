...
class PublicInboxEntity
  ...
  def make
    opts = @_entopts.dup
    PublicInboxEntity.new(@_client, opts)
  end
  ...
  # @return [PublicInbox, Hash] the current PublicInbox data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PublicInbox fields)
  def match_get
  ...
  #
  # @param reqmatch [PublicInboxListMatch, Hash, nil] match filter (any subset of
  #   PublicInbox fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PublicInbox>, Array] the matching PublicInbox items; raises RailwayStationPhotosError on failure
