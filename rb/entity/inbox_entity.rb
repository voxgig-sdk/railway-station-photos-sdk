# RailwayStationPhotos SDK Inbox entity
...
class InboxEntity
  ...
  #
  # @param reqmatch [InboxListMatch, Hash, nil] match filter (any subset of
  #   Inbox fields); defaults to nil, treated as an empty match that lists all.
