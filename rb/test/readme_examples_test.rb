...
#      offline in seeded test mode (RailwayStationPhotosSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RailwayStationPhotos_sdk.rb")
  SDK_CLASS = "RailwayStationPhotosSDK"
  ...
  SDK_BASE = "RailwayStationPhotos_sdk"
