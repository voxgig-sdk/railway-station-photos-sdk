// Command RailwayStationPhotos-cli is a CLI + REPL for the RailwayStationPhotos SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      RAILWAY_STATION_PHOTOS_APIKEY (api key), RAILWAY_STATION_PHOTOS_BASE (base url override)")
