# RailwayStationPhotos SDK — Agent Guide
...
**Entities** (16): `AdminInbox`, `Country`, `Inbox`, `InboxCount`, `InboxEntry`, `InboxStateQuery`, `OAuthToken`, `Oauth`, `Photo`, `PhotoDownload`, `PhotoStation`, `PhotoUpload`, `Photographer`, `Profile`, `PublicInbox`, `Stat`.
