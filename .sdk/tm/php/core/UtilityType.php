...
// RailwayStationPhotos SDK utility type

class RailwayStationPhotosUtility
{
    ...
    public static function copy(RailwayStationPhotosUtility $src): RailwayStationPhotosUtility
    {
        $u = new RailwayStationPhotosUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
