...
// RailwayStationPhotos SDK pipeline test
//
...
{
    private static function utility(): RailwayStationPhotosUtility
    {
        return new RailwayStationPhotosUtility();
    }
    ...
    private static function ctx(array $over = []): RailwayStationPhotosContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RailwayStationPhotosContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RailwayStationPhotosOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RailwayStationPhotosError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RailwayStationPhotosOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RailwayStationPhotosMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RailwayStationPhotosOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RailwayStationPhotosMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RailwayStationPhotosOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RailwayStationPhotosMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RailwayStationPhotosSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RailwayStationPhotosMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RailwayStationPhotosResponse([]),
            'result' => new RailwayStationPhotosResult([]),
        ]);
        [, $err] = RailwayStationPhotosMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RailwayStationPhotosSpec([]),
            'response' => null,
            'result' => new RailwayStationPhotosResult([]),
        ]);
        [, $err] = RailwayStationPhotosMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RailwayStationPhotosSpec(['step' => 's']),
            'response' => new RailwayStationPhotosResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RailwayStationPhotosResult([]),
        ]);
        [, $err] = RailwayStationPhotosMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RailwayStationPhotosSpec(['step' => 's']),
            'response' => new RailwayStationPhotosResponse(self::resp(200, ['v' => 1])),
            'result' => new RailwayStationPhotosResult([]),
        ]);
        [, $err] = RailwayStationPhotosMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RailwayStationPhotosSpec(['step' => 's']),
            'response' => new RailwayStationPhotosResponse(self::resp(200, ['v' => 2])),
            'result' => new RailwayStationPhotosResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RailwayStationPhotosMakeResponse::call($ctx);
    ...
    {
        $preset = new RailwayStationPhotosResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RailwayStationPhotosSpec([]),
            'response' => new RailwayStationPhotosResponse([]),
            'result' => new RailwayStationPhotosResult([]),
        ...
        [$got, $err] = RailwayStationPhotosMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RailwayStationPhotosResult([])]);
        [, $err] = RailwayStationPhotosMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RailwayStationPhotosSpec([]), 'result' => null]);
        [, $err] = RailwayStationPhotosMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RailwayStationPhotosSpec(['step' => 's']),
            'result' => new RailwayStationPhotosResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RailwayStationPhotosOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RailwayStationPhotosMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RailwayStationPhotosSpec(['step' => 's']),
            'result' => new RailwayStationPhotosResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RailwayStationPhotosOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RailwayStationPhotosMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RailwayStationPhotosResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RailwayStationPhotosSpec([]),
            'result' => new RailwayStationPhotosResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RailwayStationPhotosMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RailwayStationPhotosMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RailwayStationPhotosError('boom', 'boom');
        $utility->fetcher = function (RailwayStationPhotosContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RailwayStationPhotosSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RailwayStationPhotosMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RailwayStationPhotosContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RailwayStationPhotosMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RailwayStationPhotosResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RailwayStationPhotosMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RailwayStationPhotosContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RailwayStationPhotosSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RailwayStationPhotosMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RailwayStationPhotosResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RailwayStationPhotosSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RailwayStationPhotosMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RailwayStationPhotosMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RailwayStationPhotosMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RailwayStationPhotosResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RailwayStationPhotosDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RailwayStationPhotosResult(['ok' => false])]);
        $this->expectException(RailwayStationPhotosError::class);
        RailwayStationPhotosDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RailwayStationPhotosResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RailwayStationPhotosMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RailwayStationPhotosMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RailwayStationPhotosBaseFeature();
        $b = new RailwayStationPhotosBaseFeature();
        RailwayStationPhotosFeatureAdd::call($ctx, $a);
        RailwayStationPhotosFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RailwayStationPhotosBaseFeature
    {
        $f = new RailwayStationPhotosBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RailwayStationPhotosFeatureAdd::call($ctx, self::named_feature('a'));
        RailwayStationPhotosFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        RailwayStationPhotosFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        RailwayStationPhotosFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        RailwayStationPhotosFeatureAdd::call($ctx, $replace);
        ...
        RailwayStationPhotosFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RailwayStationPhotosContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RailwayStationPhotosSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RailwayStationPhotosPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RailwayStationPhotosPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RailwayStationPhotosResponse(['headers' => null]),
            'result' => new RailwayStationPhotosResult([]),
        ]);
        RailwayStationPhotosResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RailwayStationPhotosResultBody::call($ctx);
