...
// RailwayStationPhotos SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RailwayStationPhotosMakeRequest
{
    public static function call(RailwayStationPhotosContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RailwayStationPhotosResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RailwayStationPhotosResponse($fetched);
        } else {
