...
// RailwayStationPhotos SDK proxy feature
...
class RailwayStationPhotosProxyFeature extends RailwayStationPhotosBaseFeature
{
    ...
    public function init(RailwayStationPhotosContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RailwayStationPhotosContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
