...
// RailwayStationPhotos SDK ratelimit feature
...
class RailwayStationPhotosRatelimitFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _acquire(RailwayStationPhotosContext $ctx): void
    {
    ...
    private function _track(RailwayStationPhotosContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
