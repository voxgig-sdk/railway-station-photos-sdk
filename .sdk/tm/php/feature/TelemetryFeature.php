...
// RailwayStationPhotos SDK telemetry feature
...
class RailwayStationPhotosTelemetryFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _close(RailwayStationPhotosContext $ctx, bool $ok): void
    {
