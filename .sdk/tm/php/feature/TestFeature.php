...
// RailwayStationPhotos SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RailwayStationPhotosTestFeature extends RailwayStationPhotosBaseFeature
{
    ...
    public function init(RailwayStationPhotosContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RailwayStationPhotosContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RailwayStationPhotosParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RailwayStationPhotosContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RailwayStationPhotosContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = RailwayStationPhotosParam::call($ctx, $k);
