...
// RailwayStationPhotos SDK utility: fetcher

class RailwayStationPhotosFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RailwayStationPhotosSDK/1.0)';
    ...
    public static function call(RailwayStationPhotosContext $ctx, string $fullurl, array $fetchdef): array
    {
