...
class AdminInboxEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RAILWAYSTATIONPHOTOS_TEST_ADMIN_INBOX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function admin_inbox_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RAILWAYSTATIONPHOTOS_TEST_ADMIN_INBOX_ENTID");
