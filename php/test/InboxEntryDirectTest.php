...
class InboxEntryDirectTest extends TestCase
{
    public function test_direct_list_inbox_entry(): void
    {
        $setup = inbox_entry_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-inbox_entry", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
