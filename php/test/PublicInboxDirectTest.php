...
class PublicInboxDirectTest extends TestCase
{
    public function test_direct_list_public_inbox(): void
    {
        $setup = public_inbox_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-public_inbox", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
