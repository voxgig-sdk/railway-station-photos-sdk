...
{
    public function test_direct_load_profile(): void
    {
        $setup = profile_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-profile", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
