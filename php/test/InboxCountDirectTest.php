...
class InboxCountDirectTest extends TestCase
{
    public function test_direct_load_inbox_count(): void
    {
        $setup = inbox_count_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-inbox_count", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
