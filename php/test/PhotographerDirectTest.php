...
class PhotographerDirectTest extends TestCase
{
    public function test_direct_load_photographer(): void
    {
        $setup = photographer_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-photographer", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
