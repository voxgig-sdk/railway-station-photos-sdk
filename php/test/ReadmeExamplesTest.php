...
// RailwayStationPhotos SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RailwayStationPhotosSDK::test)
...
{
    private const SDK_CLASS = 'RailwayStationPhotosSDK';
    ...
    private const SDK_BASE = 'railwaystationphotos_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../railwaystationphotos_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
