...
class PhotoDownloadDirectTest extends TestCase
{
    public function test_direct_load_photo_download(): void
    {
        $setup = photo_download_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-photo_download", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
