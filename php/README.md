...
The PHP SDK for the RailwayStationPhotos API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->AdminInbox(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->RailwayStationPhotos(null)->load(
    ["id" => "test01"], null
);
