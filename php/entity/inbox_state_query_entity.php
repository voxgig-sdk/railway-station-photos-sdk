...
class InboxStateQueryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InboxStateQueryEntity($this->_client, $opts);
    }

    /**
     * @param InboxStateQuery|array $args InboxStateQuery data (assoc-array) to store.
     */
    ...
    /**
     * @return InboxStateQuery|array The current InboxStateQuery data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InboxStateQuery fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InboxStateQuery fields).
     */
