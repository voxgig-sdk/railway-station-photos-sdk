...
// RailwayStationPhotos SDK PhotoDownload entity
...
class PhotoDownloadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PhotoDownloadEntity($this->_client, $opts);
    }

    /**
     * @param PhotoDownload|array $args PhotoDownload data (assoc-array) to store.
     */
    ...
    /**
     * @return PhotoDownload|array The current PhotoDownload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhotoDownload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhotoDownload fields).
     */
    ...
    /**
     * Load a single PhotoDownload.
     *
     * @param PhotoDownloadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PhotoDownloadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhotoDownload|array The loaded PhotoDownload as an assoc-array at the
