...
// RailwayStationPhotos SDK PublicInbox entity
...
class PublicInboxEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PublicInboxEntity($this->_client, $opts);
    }

    /**
     * @param PublicInbox|array $args PublicInbox data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicInbox|array The current PublicInbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicInbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicInbox fields).
     */
    ...
    /**
     * List PublicInbox items matching the given filter.
     *
     * @param PublicInboxListMatch|array|null $reqmatch Match filter (any subset
     *   of PublicInbox fields) as an assoc-array; PublicInboxListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicInbox[]|array A list of PublicInbox items as assoc-arrays at
