...
// RailwayStationPhotos SDK InboxEntry entity
...
class InboxEntryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InboxEntryEntity($this->_client, $opts);
    }

    /**
     * @param InboxEntry|array $args InboxEntry data (assoc-array) to store.
     */
    ...
    /**
     * @return InboxEntry|array The current InboxEntry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InboxEntry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InboxEntry fields).
     */
    ...
    /**
     * List InboxEntry items matching the given filter.
     *
     * @param InboxEntryListMatch|array|null $reqmatch Match filter (any subset
     *   of InboxEntry fields) as an assoc-array; InboxEntryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InboxEntry[]|array A list of InboxEntry items as assoc-arrays at
