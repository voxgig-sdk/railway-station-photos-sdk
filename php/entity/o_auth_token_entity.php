...
// RailwayStationPhotos SDK OAuthToken entity
...
class OAuthTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OAuthTokenEntity($this->_client, $opts);
    }

    /**
     * @param OAuthToken|array $args OAuthToken data (assoc-array) to store.
     */
    ...
    /**
     * @return OAuthToken|array The current OAuthToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OAuthToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OAuthToken fields).
     */
     ...
     *
     * @param OAuthTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OAuthTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OAuthToken|array The created OAuthToken as an assoc-array at the
