...
// RailwayStationPhotos SDK PhotoUpload entity
...
class PhotoUploadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PhotoUploadEntity($this->_client, $opts);
    }

    /**
     * @param PhotoUpload|array $args PhotoUpload data (assoc-array) to store.
     */
    ...
    /**
     * @return PhotoUpload|array The current PhotoUpload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhotoUpload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhotoUpload fields).
     */
    ...
    /**
     * Create a new PhotoUpload.
     *
     * @param PhotoUploadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PhotoUploadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhotoUpload|array The created PhotoUpload as an assoc-array at the
