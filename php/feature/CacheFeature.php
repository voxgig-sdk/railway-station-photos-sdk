...
// RailwayStationPhotos SDK cache feature
...
class RailwayStationPhotosCacheFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _through(RailwayStationPhotosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
