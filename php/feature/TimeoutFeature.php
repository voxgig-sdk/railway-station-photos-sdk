...
// RailwayStationPhotos SDK timeout feature
...
class RailwayStationPhotosTimeoutFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _with_timeout(RailwayStationPhotosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RailwayStationPhotosContext $_ctx, float $ms): void
    {
        $client = $this->client;
