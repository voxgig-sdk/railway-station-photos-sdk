...
// RailwayStationPhotos SDK audit feature
...
class RailwayStationPhotosAuditFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _emit(RailwayStationPhotosContext $ctx, string $outcome): void
    {
