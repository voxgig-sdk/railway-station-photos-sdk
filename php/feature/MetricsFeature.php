...
// RailwayStationPhotos SDK metrics feature
...
class RailwayStationPhotosMetricsFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _record(RailwayStationPhotosContext $ctx, bool $ok): void
    {
