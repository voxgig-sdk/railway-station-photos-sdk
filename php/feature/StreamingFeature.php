...
// RailwayStationPhotos SDK streaming feature
...
class RailwayStationPhotosStreamingFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _iterate(RailwayStationPhotosResult $result): \Generator
    {
    ...
    private function _streamable(RailwayStationPhotosContext $ctx): bool
    {
