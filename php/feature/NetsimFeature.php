...
// RailwayStationPhotos SDK netsim feature
...
class RailwayStationPhotosNetsimFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _simulate(RailwayStationPhotosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RailwayStationPhotosContext $ctx, array $applied): void
    {
        $client = $this->client;
