...
// RailwayStationPhotos SDK clienttrack feature
...
class RailwayStationPhotosClienttrackFeature extends RailwayStationPhotosBaseFeature
{
    ...
    public function PostConstruct(RailwayStationPhotosContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RailwayStationPhotos-SDK';
