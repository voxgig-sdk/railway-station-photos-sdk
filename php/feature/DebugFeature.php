...
// RailwayStationPhotos SDK debug feature
...
class RailwayStationPhotosDebugFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _finish(RailwayStationPhotosContext $ctx, bool $ok): void
    {
