...
// RailwayStationPhotos SDK rbac feature
...
class RailwayStationPhotosRbacFeature extends RailwayStationPhotosBaseFeature
{
    ...
    private function _required(RailwayStationPhotosContext $ctx): ?string
    {
    ...
    private function _reject(RailwayStationPhotosContext $ctx, string $required): void
    {
    ...
    private function _track(RailwayStationPhotosContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
